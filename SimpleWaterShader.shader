...
/*SF_DATA;ver:1.37;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,lico:1,lgpr:1,limd:1,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:3,bdst:7,dpts:2,wrdp:False,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.1280277,fgcg:0.1953466,fgcb:0.2352941,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:8528,x:32719,y:32712,varname:node_8528,prsc:2|diff-8635-RGB,alpha-3496-OUT,refract-3842-OUT;n:type:ShaderForge.SFN_Color,id:8635,x:32273,y:32608,ptovrint:False,ptlb:water color,ptin:_watercolor,varname:_watercolor,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.3919766,c2:0.5676904,c3:0.9191176,c4:0.5;n:type:ShaderForge.SFN_Vector1,id:3496,x:32373,y:32989,cmnt:Opacity,varname:node_3496,prsc:2,v1:0.24;n:type:ShaderForge.SFN_Tex2d,id:8234,x:32137,y:33064,ptovrint:False,ptlb:texture noise,ptin:_texturenoise,varname:_texturenoise,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:28c7aad1372ff114b90d330f8a2dd938,ntxv:0,isnm:False|UVIN-2777-UVOUT;n:type:ShaderForge.SFN_ComponentMask,id:6745,x:32316,y:33071,varname:node_6745,prsc:2,cc1:0,cc2:1,cc3:-1,cc4:-1|IN-8234-RGB;n:type:ShaderForge.SFN_Multiply,id:3842,x:32548,y:33116,varname:node_3842,prsc:2|A-6745-OUT,B-8589-OUT;n:type:ShaderForge.SFN_Slider,id:8589,x:32202,y:33290,ptovrint:False,ptlb:refraction,ptin:_refraction,varname:_refraction,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.12,max:1;n:type:ShaderForge.SFN_Panner,id:2777,x:31884,y:33030,varname:node_2777,prsc:2,spu:0.1,spv:0.1|UVIN-5769-UVOUT;n:type:ShaderForge.SFN_TexCoord,id:5769,x:31680,y:33030,varname:node_5769,prsc:2,uv:0,uaff:False;proporder:8635-8234-8589;pass:END;sub:END;*/
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float4 node_3544 = _Time + _TimeEditor;
                float2 node_2777 = (i.uv0+node_3544.g*float2(0.1,0.1));
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                i.screenPos.y *= _ProjectionParams.x;
                float3 normalDirection = i.normalDir;
                float4 node_1972 = _Time + _TimeEditor;
                float2 node_2777 = (i.uv0+node_1972.g*float2(0.1,0.1));
                float4 _texturenoise_var = tex2D(_texturenoise,TRANSFORM_TEX(node_2777, _texturenoise));
                float2 sceneUVs = float2(1,grabSign)*i.screenPos.xy*0.5+0.5 + (_texturenoise_var.rgb.rg*_refraction);
                float4 sceneColor = tex2D(_GrabTexture, sceneUVs);
